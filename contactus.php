...
<head>
    ...
    <title>Qualesce | Contact Us Form</title>
    <link rel="icon" href="img/qlogo.svg">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css"
        integrity="sha384-zCbKRCUGaJDkqS1kPbPd7TveP5iyJE0EjAuZQTgFLD2ylzuqKfdKlfG/eSrtxUkn" crossorigin="anonymous">
    <link rel="stylesheet" type = "text/css" href="css/allforms.css">
</head>

<body>
    <!-- <h2 style = "text-align: center;">Contact Us</h2> -->
    <form method="POST" class="post-form" action="postcontactus.php">  
        <div class="container">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="description" placeholder="Query Details" required >
                            </div>
                        </div>    
                    </div>
